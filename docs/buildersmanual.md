...
* `*Dialog` - string - the name of the dialog that each crowd member will access when a conversation occurs with a PC.  Unless you have a scripter build a different conversation, you can leave this blank or delete it.  If missing, a basic default one-line conversation will be used.
