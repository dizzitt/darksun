...
effect SetSummonEffect(int nSpellID)
{
    ...
    else  //WITOUT THE ANIMAL DOMAIN
    {
        if(nSpellID == SPELL_SUMMON_CREATURE_I)
        {
        ...
        else if(nSpellID == SPELL_SUMMON_CREATURE_II)
          {
             ...
             switch (nRoll)
            {
                ...
                case 2:
                    sSummon = "NW_S_baazrag";
                break;

                case 3:
                    sSummon = "NW_S_rasclinn";
                break;
            }
        }
        else if(nSpellID == SPELL_SUMMON_CREATURE_III)
        {
            ...
            {
                case 1:
                    sSummon = "NW_S_desbeet";
                break;

                case 2:
                    sSummon = "NW_S_hornbeet";
                break;
       ...
       switch (nRoll)
            {
                case 1:
                    sSummon = "NW_S_desspider";
                break;

                case 2:
                    sSummon = "NW_S_sandhowler";
                break;
       ...
       switch (nRoll)
            {
                ...
                case 2:
                    sSummon = "NW_S_fordorran";
                break;

                case 3:
                    sSummon = "NW_S_sandmite";
                break;
            }
        }
        else if(nSpellID == SPELL_SUMMON_CREATURE_VI)
       ...
       switch (nRoll)
        ...
        else if(nSpellID == SPELL_SUMMON_CREATURE_VIII)
        {
            ...
            switch (nRoll)
            {
                ...
                case 2:
                    sSummon = "NW_S_ssurran";
                break;

                case 3:
                    sSummon = "NW_S_eardrake";
                break;
            }
        }
        else if(nSpellID == SPELL_SUMMON_CREATURE_IX)
        {
            ...
            {
                case 1:
                    sSummon = "NW_S_eldearele";
                break;

                case 2:
                    sSummon = "NW_S_firedrake";
                break;

                case 3:
                    sSummon = "NW_S_silthor";
                break;
            }
        }
    }
